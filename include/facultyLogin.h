...
public:
    ...
    void viewSchedule()         
    {
        ...
        ifstream f1("C:/Users/ASUS/Desktop/iitg_docs_kash/Training-Schedule-Management-main/Project_Flies/data/trainerallotment.csv");
        ...
        if (flag == 1)
        {
            ...
            if (cin.fail())
            {
                cin.clear();
                cin.ignore(512, '\n');
                cout << "\nOops you've entered wrong input. Taking you back to dashboard." << endl;
                facultyModules();
            }
    ...
    void cancelSchedule()       
    {
        if (status == "yes" || status == "y" || status == "YES" || status == "Y" || status == "Yes")
        {
            ...
            if (option == "N" || option == "no" || option == "NO" || option == "n" || option == "No")
            {
                facultyModules();
            }
            else
